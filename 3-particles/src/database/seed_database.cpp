...
bool seed_database(const std::string& DB_PATH) {
    ...
    const unsigned int CAMERA_XINI = 0;
    const unsigned int CAMERA_YINI = 0;
    const unsigned int CAMERA_ZINI = -200;
    ...
    std::string cameraSQLInsert =
        "INSERT OR REPLACE INTO camera (id, x, y, z, wx, wy, width, height) VALUES (" +
